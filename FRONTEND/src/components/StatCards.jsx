...
export default function StatCards() {
  ...
  return (
    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 mb-6">
      ...
      <div className="bg-[#151c28] border border-slate-800 hover:border-slate-700 rounded-xl p-4 shadow-lg transition-all relative overflow-hidden group">
        ...
        <div className="flex items-center justify-between">
          <div>
            <p className="text-xs font-medium text-slate-400 uppercase tracking-wider">Active Hazard Zones</p>
            <div className="flex items-baseline space-x-2 mt-1">
              <span className="text-3xl font-extrabold text-white font-mono-numeric">{zones.length}</span>
              {criticalZonesCount > 0 && (
                <span className="text-xs font-semibold text-rose-400 bg-rose-950/80 px-2 py-0.5 rounded border border-rose-800/60">
      ...
      <div className="bg-[#151c28] border border-slate-800 hover:border-slate-700 rounded-xl p-4 shadow-lg transition-all relative overflow-hidden group">
        ...
        <div className="flex items-center justify-between">
          <div>
            <p className="text-xs font-medium text-slate-400 uppercase tracking-wider">People Exposed</p>
            <p className="text-3xl font-extrabold text-white font-mono-numeric mt-1">
      ...
      <div className="bg-[#151c28] border border-slate-800 hover:border-slate-700 rounded-xl p-4 shadow-lg transition-all relative overflow-hidden group">
        <div className="absolute -right-4 -bottom-4 w-20 h-20 bg-cyan-500/5 rounded-full blur-xl group-hover:bg-cyan-500/10 transition-all"></div>
        <div className="flex items-center justify-between">
          <div>
            <p className="text-xs font-medium text-slate-400 uppercase tracking-wider">Responders Deployed</p>
            <div className="flex items-baseline space-x-1 mt-1">
              <span className="text-3xl font-extrabold text-cyan-400 font-mono-numeric">
      ...
      <div className="bg-[#151c28] border border-slate-800 hover:border-slate-700 rounded-xl p-4 shadow-lg transition-all relative overflow-hidden group">
        <div className="absolute -right-4 -bottom-4 w-20 h-20 bg-purple-500/5 rounded-full blur-xl group-hover:bg-purple-500/10 transition-all"></div>
        <div className="flex items-center justify-between">
          <div>
            <p className="text-xs font-medium text-slate-400 uppercase tracking-wider">Shelters at Capacity</p>
            <div className="flex items-baseline space-x-1 mt-1">
              <span className="text-3xl font-extrabold text-purple-400 font-mono-numeric">
