...
/**
 * Reusable accessible TextInput component with icon, validation error state, and helper text.
 */
    ...
    <div className={`space-y-1.5 ${className}`}>
      ...
      <div className="relative rounded-lg shadow-sm">
        ...
        <input
          ...
          className={`block w-full text-sm rounded-lg transition-colors py-2.5 ${
            Icon ? 'pl-9' : 'pl-3.5'
          } pr-3.5 ${
            error
